...
UKismetSystemLibrary::PrintString(GWorld, FString::Printf(Format, ##__VA_ARGS__), true, true, FLinearColor(1.0f, 1.0f, 0.0f), 5.0f); \
}
#define LOG_ERROR(Format, ...) \
{ \
UE_LOG(LogMounteaDialogueSystem, Error, Format, ##__VA_ARGS__); \
UKismetSystemLibrary::PrintString(GWorld, FString::Printf(Format, ##__VA_ARGS__), true, true, FLinearColor(1.0f, 0.0f, 0.0f), 5.0f); \
}
