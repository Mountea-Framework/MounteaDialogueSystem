...
public:
	...
	UFUNCTION(BlueprintNativeEvent, Category = "Mountea|Dialogue|Decorators", meta=(CustomTag="MounteaK2Getter"))
...
public:
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, Category = "Mountea|Dialogue|Decorators", meta=(CustomTag="MounteaK2Setter"))
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, Category = "Mountea|Dialogue|Decorators", meta=(CustomTag="MounteaK2Validate"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Mountea|Dialogue|Decorators", meta=(CustomTag="MounteaK2Setter"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Mountea|Dialogue|Decorators", meta=(CompactNodeTitle="World"), meta=(CustomTag="MounteaK2Getter"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="Mountea|Dialogue|Decorators", meta=(CompactNodeTitle="OwningNode"), meta=(CustomTag="MounteaK2Getter"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="Mountea|Dialogue|Decorators", meta=(CompactNodeTitle="OwningGraph"), meta=(CustomTag="MounteaK2Getter"))
	UMounteaDialogueGraph* GetOwningGraph() const;
	/**
	 * Returns Owning Object of this Decorator.
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="Mountea|Dialogue|Decorators", meta=(CompactNodeTitle="Owner"), meta=(CustomTag="MounteaK2Getter"))
	UObject* GetOwner() const;
	/**
	 * Returns Owner Participant Interface.
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="Mountea|Dialogue|Decorators", meta=(CompactNodeTitle="OwnerParticipant"), meta=(CustomTag="MounteaK2Getter"))
